...
export default {
  ...
  data() {
    return {
      images: [
        { src: "/img/i1.jpg", title: "图片1" },
        { src: "/img/i2.jpg", title: "图片2" },
        { src: "/img/i3.jpg", title: "图片3" },
        { src: "/img/i4.jpg", title: "图片4" },
        { src: "/img/i5.jpg", title: "图片5" },
        { src: "/img/i6.jpg", title: "图片6" },
        { src: "/img/i7.jpg", title: "图片7" },
        { src: "/img/i8.jpg", title: "图片8" },
        { src: "/img/i9.jpg", title: "图片9" },
      ],
      showSearchBox: false,
      searchTerm: "",
      filteredImages: [],
